...
if [ "$1" == "start" ]; then
    ...
    docker pause minecraft nitrox openwebui ollama nextcloud cloudflared playit traefik 2>/dev/null || echo "Some containers were not running."
    ...
    docker unpause minecraft nitrox openwebui ollama nextcloud cloudflared playit traefik 2>/dev/null || echo "Some containers were not paused."
